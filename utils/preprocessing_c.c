 ...
 */
    ...
    __pyx_t_11 = -1;
    if (__pyx_t_19 < 0) {
      __pyx_t_19 += __pyx_v_deriv.shape[0];
      if (unlikely(__pyx_t_19 < 0)) __pyx_t_11 = 0;
    } else if (unlikely(__pyx_t_19 >= __pyx_v_deriv.shape[0])) __pyx_t_11 = 0;
    if (unlikely(__pyx_t_11 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_11);
      __PYX_ERR(0, 11, __pyx_L1_error)
    }
    *((double *) ( /* dim=0 */ (__pyx_v_deriv.data + __pyx_t_19 * __pyx_v_deriv.strides[0]) )) = (__pyx_t_20 / __pyx_v_den);
